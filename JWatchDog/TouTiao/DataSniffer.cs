...
namespace JWatchDog.TouTiao
{
    public class DataSniffer : DataSnifferBase
    {
        ...
        public TTStatsList GetData(int daysBeforeToday, string[] needCols,bool isDebug = false,bool isMonthlyData = false)
        {
        ...
        private static TTStatsList ReadAllData(ref EdgeDriver driver)
        {
        ...
        private static TTStatsList ReadData(ref EdgeDriver driver)
        {
            // 等待网络响应
            for (int i = 0; i < 10; i++)
            {
